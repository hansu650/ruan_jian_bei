...
def main() -> int:
    reporter = Reporter()
    print("EduForge 智学工坊 - Phase 14A 学生端 UI 修复与内容渲染环境自检")
    print()
    ...
    print()
    print("[OK] 环境自检通过，可以继续启动前后端或运行 Phase 14A 检查。")
    return 0
