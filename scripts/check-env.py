...
def main() -> int:
    reporter = Reporter()
    print("EduForge 智学工坊 - Phase 13 端到端彩排与缺陷修复环境自检")
    print()
    ...
    print()
    print("[OK] 环境自检通过，可以继续启动前后端或运行 Phase 13 检查。")
    return 0
